...
### Обо мне
Занимаюсь разработкой web-страниц и приложений различной сложности <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">, стремлюсь расширить и углубить свои знания. Открыта к предложениям как частных проектов так и компаний и интеграторов на должность Frontend developer / Web developer 
