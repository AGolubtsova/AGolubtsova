...
### Обо мне
- <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">Занимаюсь разработкой web-страниц и приложений различной сложности, стремлюсь расширить и углубить свои знания
- :woman_technologist: Читаю блоги и информационные каналы, слушаю подкасты разработчиков и дизайнеров из разных стран, изучаю новые технологии, решаю задачи на CodeWars, делаю pet-проекты👨‍🎓
- 💬 Легко нахожу язык с коллегами, клиентами и учениками, так как имею богатый опыт общения с разными людьми
